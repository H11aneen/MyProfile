...
export default function Header({
  ...
  return (
    <header className="fixed top-0 right-0 left-0 z-50 border-b border-border/20 bg-background/80 backdrop-blur-sm">
      <div className="w-full px-4 md:px-6">
        <div className="flex items-center justify-between h-16 max-w-7xl mx-auto">
          {/* Logo */}
          <div className="text-2xl font-bold tracking-wider order-3 md:order-1">
            <span className="text-primary">.HANIN</span>
          </div>
